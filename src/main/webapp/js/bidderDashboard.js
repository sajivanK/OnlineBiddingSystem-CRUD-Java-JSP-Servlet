...
document.addEventListener("DOMContentLoaded", (ev) => {
  ...
  // Add event listener to Products link
  document.querySelector("a[href='#edit-profil']").addEventListener("click", showProductPage);

  // Event listener for the Dashboard link to go back to the dashboard
  document.querySelector("a[href='#dashboard']").addEventListener("click", showDashboard);
});

// Function to show the product page and hide the dashboard
const showProductPage = () => {
  document.getElementById('dashboard-main').style.display = 'none';
  document.getElementById('product-page').style.display = 'block';
};

// Function to show the dashboard and hide the product page
const showDashboard = () => {
